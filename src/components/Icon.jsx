const icons = {
  ...
  mindfulness: '<path d="M12 4c2.5 2.4 3.6 4.7 0 8-3.6-3.3-2.5-5.6 0-8Z"/><path d="M5 10c3.2.4 5.3 2.1 7 5-3.7 1-6.4-.7-7-5ZM19 10c-3.2.4-5.3 2.1-7 5 3.7 1 6.4-.7 7-5Z"/><path d="M4 17c2.7 2 5.3 2.7 8 2.7s5.3-.7 8-2.7"/>',
  vision: '<path d="m3 19 5.5-7 3.2 4 2.5-3 6.8 6H3Z"/><path d="m17.5 4 .7 1.8L20 6.5l-1.8.7-.7 1.8-.7-1.8-1.8-.7 1.8-.7.7-1.8Z"/>',
